...
/**
 * This is the item provider adapter for a {@link istarmodel1.Quality} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Quality_qualifies_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Quality_qualifies_feature", "_UI_Quality_type"),
				 IstarmodelPackage.Literals.QUALITY__QUALIFIES,
				 true,
				 false,
				 true,
				 null,
