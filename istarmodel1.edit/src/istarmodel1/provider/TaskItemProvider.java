...
/**
 * This is the item provider adapter for a {@link istarmodel1.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_provides_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_provides_feature", "_UI_Task_type"),
				 IstarmodelPackage.Literals.TASK__PROVIDES,
				 true,
				 false,
				 true,
				 null,
