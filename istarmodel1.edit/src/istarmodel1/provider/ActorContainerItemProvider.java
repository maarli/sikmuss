...
/**
 * This is the item provider adapter for a {@link istarmodel1.ActorContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActorContainerItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IstarmodelPackage.Literals.ACTOR_CONTAINER__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(IstarmodelPackage.Literals.ACTOR_CONTAINER__CONTAINS);
			childrenFeatures.add(IstarmodelPackage.Literals.ACTOR_CONTAINER__HAS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(IstarmodelPackage.Literals.ACTOR_CONTAINER__CONTAINS,
		...
		newChildDescriptors.add
			(createChildParameter
				(IstarmodelPackage.Literals.ACTOR_CONTAINER__HAS,
